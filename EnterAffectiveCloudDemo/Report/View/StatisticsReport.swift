...
class StatisticsReport: BaseView {
    public var number: Int = 0{
        willSet {
            ...
            let attributedText = NSMutableAttributedString(string:"🎊🎉 这是我第 \(newValue) 次训练。")
            attributedText.addAttributes([NSAttributedString.Key.font:UIFont.systemFont(ofSize: 17, weight: .bold)], range: NSMakeRange(10, intLen))
    ...
    public var count: Int = 0{
        willSet {
            ...
            style.lineSpacing = 5
            let attributedText = NSMutableAttributedString(string:"✌️我已经训练了 \(newValue) 分钟。👏👏")
            attributedText.addAttributes([NSAttributedString.Key.font:UIFont.systemFont(ofSize: 17, weight: .bold)], range: NSMakeRange(9, iLen))
