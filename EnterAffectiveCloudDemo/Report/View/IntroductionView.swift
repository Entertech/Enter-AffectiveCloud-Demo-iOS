...
//    public var lessen:String = "" {
//        willSet {
//            lessionLabel.text = "\(newValue)."
//        }
//    }
    public var total: Int = 0 {
        willSet {
            timesLabel.text = "\(newValue)"
        }
    }
...
//    private let learnedView = UIView()
//    private let learnedLabel = UILabel()
//    private let lessionLabel = UILabel()
...
//        learnedLabel.text = "I have learned "
//        learnedLabel.textColor = .white
//        learnedLabel.font = UIFont.systemFont(ofSize: 16)
//        learnedView.addSubview(learnedLabel)
//
//        lessionLabel.font = UIFont.systemFont(ofSize: 16, weight: .semibold)
//        lessionLabel.textColor = .white
//        learnedView.addSubview(lessionLabel)
...
//        learnedView.backgroundColor = UIColor.colorWithHexString(hexColor: "#52A27C")
//        learnedView.layer.cornerRadius = 12
...
//        }
//
//        lessionLabel.snp.makeConstraints {
//            $0.left.equalTo(learnedLabel.snp.right)
//            $0.centerY.equalTo(learnedLabel.snp.centerY)
//        }
//
//        learnedView.snp.makeConstraints {
//            $0.left.equalToSuperview().offset(16)
//            $0.right.equalToSuperview().offset(-16)
//            $0.top.equalTo(clockImage.snp.bottom).offset(18)
