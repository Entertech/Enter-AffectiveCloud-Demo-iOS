...
open class BaseLoader: UIView, CAAnimationDelegate {
    ...
    open var rectSize: CGFloat = UIScreen.main.bounds.height/6
    ...
    internal func generateLoader() {
        preconditionFailure("Call this method from the desired BaseLoader type class")
    }
